<template>
  <div class="container mt-2">
    <div class="mi-imagen container"></div>
    ...
    <b-modal id="bv-modal-example" hide-footer>
      <template v-slot:modal-title>
        Instrucciones
        <code>Palabras encadenadas</code> juego:
      </template>
      <div class="d-block text-center">
        <h3>
          El juego consite en encadenar palabras, debe de coincidir la ultima letra de la palabra actual
          con la primera letra de la nueva palabra, sino coincide terminara el juego
        </h3>
      </div>
    ...
    <template v-else>
      ...
      <addPalabra v-bind:palabras="palabras" v-bind:estado="estado"></addPalabra>
